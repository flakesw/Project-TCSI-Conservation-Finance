...
scenarios <- c("subset_scenario3 - new suppression test spread", "subset_scenario3 - new suppression test spread - Copy")
# scenarios <- c("Scenario1", "Scenario1 - miroc")
...
# setwd("./subset_scenario3/")
setwd("./Scenario1/")

fire_summary <- read.csv("./scrapple-summary-log.csv")
fire_summary1 <- fire_summary
events1 <- read.csv("./scrapple-events-log.csv")


# setwd("../subset_scenario3 - new suppression/")
setwd("../Scenario1 - miroc/")

fire_summary <- read.csv("./scrapple-summary-log.csv")
fire_summary2 <- fire_summary
events2 <- read.csv("./scrapple-events-log.csv")

boxplot(events1$TotalSitesBurned, events2$TotalSitesBurned)
...
fire_summary1$TotalBurnedSites <- fire_summary1$TotalBurnedSitesAccidental + 
                                    fire_summary1$TotalBurnedSitesLightning + 
                                      fire_summary1$TotalBurnedSitesRx
fire_summary1$TotalFires <- fire_summary1$NumberFiresAccidental + 
                                       fire_summary1$NumberFiresLightning + 
                                       fire_summary1$NumberFiresRx
(fire_summary1$TotalBurnedSites / fire_summary1$TotalFires) #average area burned per fire by year

fire_summary2$TotalBurnedSites <- fire_summary2$TotalBurnedSitesAccidental + 
  fire_summary2$TotalBurnedSitesLightning + 
  fire_summary2$TotalBurnedSitesRx
fire_summary2$TotalFires <- fire_summary2$NumberFiresAccidental + 
  fire_summary2$NumberFiresLightning + 
  fire_summary2$NumberFiresRx
(fire_summary2$TotalBurnedSites / fire_summary2$TotalFires) #average area burned per fire by year

plot(fire_summary1$TotalBurnedSites ~ fire_summary2$TotalBurnedSites)
abline(0,1)
...
short_ca <- readRDS("../calibration data/short_tcsi/short_ca.RDS") %>%
...
hist(I(fire_summary1$NumberFiresAccidental + fire_summary1$NumberFiresLightning))
mean(fire_summary1$TotalFires)
...
vioplot(I(fire_summary1$NumberFiresAccidental + fire_summary1$NumberFiresLightning), 
        I(fire_summary2$NumberFiresAccidental + fire_summary2$NumberFiresLightning),
...
vioplot(fire_summary1$NumberFiresAccidental, fire_summary2$NumberFiresAccidental,
...
hist(fire_summary1$NumberFiresLightning)
mean(fire_summary1$NumberFiresLightning)
var(fire_summary1$NumberFiresLightning)
hist(fire_summary2$NumberFiresLightning)
mean(fire_summary2$NumberFiresLightning)
var(fire_summary2$NumberFiresLightning)
...
vioplot(fire_summary1$NumberFiresLightning, fire_summary2$NumberFiresLightning, n_fires_short_tcsi_by_year_type[n_fires_short_tcsi_by_year_type$cause == "Natural", ]$n * subset_proportion_tcsi,
...
hist(fire_summary1$TotalBurnedSitesAccidental*3.24) #convert to ha
mean(fire_summary1$TotalBurnedSitesAccidental*3.24)
var(fire_summary1$TotalBurnedSitesAccidental*3.24)
hist(fire_summary2$TotalBurnedSitesAccidental*3.24) #convert to ha
mean(fire_summary2$TotalBurnedSitesAccidental*3.24)
var(fire_summary2$TotalBurnedSitesAccidental*3.24)
...
vioplot(fire_summary1$TotalBurnedSitesAccidental*3.24, 
        fire_summary2$TotalBurnedSitesAccidental*3.24, 
...
vioplot(fire_summary1$TotalBurnedSitesLightning*3.24, 
        fire_summary2$TotalBurnedSitesLightning*3.24, 
...
hist(log(events2$TotalSitesBurned * 3.24)) #convert to ha
mean(log(events2$TotalSitesBurned * 3.24))
...
vioplot(log(events1$TotalSitesBurned*3.24), 
        log(events2$TotalSitesBurned*3.24), 
        log(short_tcsi$FIRE_SIZE / 2.47),
        log(short_ca$FIRE_SIZE / 2.47), col = c("gray", "gray", "blue", "blue"))
...
vioplot(events1$InitialDayOfYear, 
        events2$InitialDayOfYear, 
        short_tcsi$DISCOVERY_DOY, 
        short_ca$DISCOVERY_DOY)
