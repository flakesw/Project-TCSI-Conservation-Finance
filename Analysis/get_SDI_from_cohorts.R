...
comm_input <- read.csv("E:/TCSI LANDIS/LANDIS runs/Scenario7 - sdi35/community-input-file-0.csv")
...
comm_map <- terra::rast("E:/TCSI LANDIS/LANDIS runs/Scenario7 - sdi35/output-community-0.img")
